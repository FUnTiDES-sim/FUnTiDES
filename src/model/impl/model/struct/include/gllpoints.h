    ...
    PROXY_HOST_DEVICE static float get(int order, int i) {
        ...
        switch(order) {
            ...
            case 3:
                switch(i) {
                    case 0: return -1.0f;
                    case 1: return -1.0f / sqrt5;
                    case 2: return 1.0f / sqrt5;
                    case 3: return 1.0f;
                }
                break;
            ...
            case 4:
                switch(i) {
                    case 0: return -1.0f;
                    case 1: return -0.654653670707977f;
                    case 2: return 0.0f;
                    case 3: return 0.654653670707977f;
                    case 4: return 1.0f;
                }
                break;
            ...
            case 5:
                switch(i) {
                    case 0: return -1.0f;
                    case 1: return -0.765055323929465f;
                    case 2: return -0.285231516480645f;
                    case 3: return 0.285231516480645f;
                    case 4: return 0.765055323929465f;
                    case 5: return 1.0f;
                }
                break;
        }
