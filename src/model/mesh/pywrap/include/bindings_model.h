...
void bind_modelunstructdata(py::module_ &m)
{
  ...
  py::class_<Data>(m, name.c_str())
      .def(py::init<ScalarType, ScalarType, ScalarType, FloatType, FloatType,
                    FloatType, bool, bool,
                    ...
                    Kokkos::Experimental::python_view_type_t<
                        FaceConnectivityUnstructData<FloatType, ScalarType>>>()
               py::arg("order"),
           py::arg("n_element"), py::arg("n_node"), py::arg("lx"),
           py::arg("ly"), py::arg("lz"), py::arg("is_model_on_nodes"),
           py::arg("is_elastic"), py::arg("global_node_index"),
           ...
           py::arg("model_gamma_element"), py::arg("model_theta_node"),
           py::arg("model_theta_element"), py::arg("model_phi_node"),
           py::arg("model_phi_element"), py::arg("model_C_tensor_element"),
           py::arg("boundaries_t"), py::arg("face_connectivity"));
}
