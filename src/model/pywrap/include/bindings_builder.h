...
void bind_cartesian_struct_builder(py::module_ &m)
{
  ...
  py::class_<T, Base, std::shared_ptr<T>>(m, name.c_str())
    .def(py::init<ScalarType, FloatType, ScalarType, FloatType, ScalarType, FloatType>(),
          py::arg("ex"), py::arg("hx"),
          py::arg("ey"), py::arg("hy"),
          py::arg("ez"), py::arg("hz"));
}
...
void bind_cartesian_unstruct_params(py::module_ &m)
{
  ...
  py::class_<Params, std::shared_ptr<Params>>(m, name.c_str())
      .def(py::init<>())
      .def(py::init<int, ScalarType, ScalarType, ScalarType, FloatType, FloatType, FloatType>(),
           py::arg("order"),
