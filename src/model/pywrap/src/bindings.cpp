...
PYBIND11_MODULE(model, m) {
  ...
  py::class_<ModelUnstructFI, ModelAPIFI, std::shared_ptr<ModelUnstructFI>>(m, "ModelUnstruct")
    ...
    .def("get_number_of_points_per_element", &ModelUnstructFI::getNumberOfPointsPerElement)
  ...
  py::class_<ModelStructFI1, ModelAPIFI, std::shared_ptr<ModelStructFI1>>(m, "ModelStructFI1")
    ...
    .def("get_number_of_points_per_element", &ModelStructFI1::getNumberOfPointsPerElement)
  ...
  py::class_<ModelStructFI2, ModelAPIFI, std::shared_ptr<ModelStructFI2>>(m, "ModelStructFI2")
    ...
    .def("get_number_of_points_per_element", &ModelStructFI2::getNumberOfPointsPerElement)
  ...
  py::class_<ModelStructFI3, ModelAPIFI, std::shared_ptr<ModelStructFI3>>(m, "ModelStructFI3")
    ...
    .def("get_number_of_points_per_element", &ModelStructFI3::getNumberOfPointsPerElement)
  ...
  py::class_<CartesianStructBuilderFI1, std::shared_ptr<CartesianStructBuilderFI1>>(m, "CartesianStructBuilderFI1")
    .def(py::init<>())
    .def("get_model", &CartesianStructBuilderFI1::getModel, py::arg("e"), py::arg("h"));
  ...
  py::class_<CartesianStructBuilderFI2, std::shared_ptr<CartesianStructBuilderFI2>>(m, "CartesianStructBuilderFI2")
    .def(py::init<>())
    .def("get_model", &CartesianStructBuilderFI2::getModel, py::arg("e"), py::arg("h"));
  ...
  py::class_<CartesianStructBuilderFI3, std::shared_ptr<CartesianStructBuilderFI3>>(m, "CartesianStructBuilderFI3")
    .def(py::init<>())
    .def("get_model", &CartesianStructBuilderFI3::getModel, py::arg("e"), py::arg("h"));

  // Bind CartesianParams<float, int>
  using CartesianParamsFI = model::CartesianParams<float, int>;
  py::class_<CartesianParamsFI, std::shared_ptr<CartesianParamsFI>>(m, "CartesianParams")
    .def(py::init<>())
  ...
  using CartesianUnstructBuilderFI = model::CartesianUnstructBuilder<float, int>;
  py::class_<CartesianUnstructBuilderFI, std::shared_ptr<CartesianUnstructBuilderFI>>(m, "CartesianUnstructBuilder")
    .def(py::init<>())
