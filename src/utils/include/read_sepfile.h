    ...
    static Header readHeader(const std::string& headerFile) {
        ...
        while (std::getline(file, line)) {
            ...
            if (pos != std::string::npos) {
                ...
                if (key == "n1") hdr.n1 = std::stoi(value);
                else if (key == "n2") hdr.n2 = std::stoi(value);
                else if (key == "n3") hdr.n3 = std::stoi(value);
                else if (key == "d1") hdr.d1 = std::stof(value);
                else if (key == "d2") hdr.d2 = std::stof(value);
                else if (key == "d3") hdr.d3 = std::stof(value);
                else if (key == "o1") hdr.o1 = std::stof(value);
                else if (key == "o2") hdr.o2 = std::stof(value);
                else if (key == "o3") hdr.o3 = std::stof(value);
                else if (key == "data_format") hdr.datatype = value;
                else if (key == "in") hdr.in = value;
            }
        }
        return hdr;
    }
