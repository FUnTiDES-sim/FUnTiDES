#ifndef SOLVER_FE_PYWRAP_INCLUDE_BINDINGS_WAVEFIELD_H_
#define SOLVER_FE_PYWRAP_INCLUDE_BINDINGS_WAVEFIELD_H_
...
#endif  // SOLVER_FE_PYWRAP_INCLUDE_BINDINGS_WAVEFIELD_H_