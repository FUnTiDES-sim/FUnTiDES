...
std::unique_ptr<Solver> makeSolverStruct(bool isModelOnNodes, physicType physic)
{
...
std::unique_ptr<Solver> makeSemSolver(int order, meshType mesh,
...
std::unique_ptr<Solver> createSolver(methodType const methodType,
