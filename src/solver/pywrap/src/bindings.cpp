...
PYBIND11_MODULE(solver, m)
{
  ...
  py::enum_<SolverFactory::methodType>(m, "MethodType").value("SEM", SolverFactory::SEM).value("DG", SolverFactory::DG);
  ...
  py::class_<SEMsolverDataAcoustic, SolverBase::DataStruct, std::shared_ptr<SEMsolverDataAcoustic>>(
      m, "SEMsolverDataAcoustic")
      .def(py::init<int, int, Kokkos::Experimental::python_view_type_t<ARRAY_REAL_VIEW>,
                    Kokkos::Experimental::python_view_type_t<ARRAY_REAL_VIEW>,
                    Kokkos::Experimental::python_view_type_t<VECTOR_INT_VIEW>,
                    Kokkos::Experimental::python_view_type_t<ARRAY_REAL_VIEW>>(),
           py::arg("i1"), py::arg("i2"), py::arg("rhs_term"), py::arg("pn_global"), py::arg("rhs_element"),
           py::arg("rhs_weights"))
  ...
  py::class_<SEMsolverDataElastic, SolverBase::DataStruct, std::shared_ptr<SEMsolverDataElastic>>(
      m, "SEMsolverDataElastic")
      .def(py::init<int, int, Kokkos::Experimental::python_view_type_t<ARRAY_REAL_VIEW>,
                    Kokkos::Experimental::python_view_type_t<ARRAY_REAL_VIEW>,
                    Kokkos::Experimental::python_view_type_t<ARRAY_REAL_VIEW>,
                    Kokkos::Experimental::python_view_type_t<ARRAY_REAL_VIEW>,
                    ...
                    Kokkos::Experimental::python_view_type_t<VECTOR_INT_VIEW>,
                    Kokkos::Experimental::python_view_type_t<ARRAY_REAL_VIEW>>(),
           py::arg("i1"), py::arg("i2"), py::arg("rhs_termx"), py::arg("rhs_termy"), py::arg("rhs_termz"),
           py::arg("uxn_global"), py::arg("uyn_global"), py::arg("uzn_global"), py::arg("rhs_element"),
           py::arg("rhs_weights"))
  ...
  py::class_<SEMSolverBase, std::shared_ptr<SEMSolverBase>>(m, "SEMSolverBase")
      ...
      .def("compute_one_step", &SEMSolverBase::computeOneStep, py::arg("dt"), py::arg("time_sample"), py::arg("data"))
      .def("output_solution_values", &SEMSolverBase::outputSolutionValues, py::arg("index_time_step"), py::arg("i1"),
           py::arg("my_element_source"), py::arg("field_global"), py::arg("field_name"));

  // Bind Solver factory function (returns shared_ptr<SolverBase>)
  m.def(
      "create_solver",
      [](SolverFactory::methodType methodType, SolverFactory::implemType implemType, SolverFactory::meshType meshType,
         SolverFactory::modelLocationType modelLocation, SolverFactory::physicType physicType, int order) {
        auto solver = SolverFactory::createSolver(methodType, implemType, meshType, modelLocation, physicType, order);
        return std::shared_ptr<SEMSolverBase>(std::move(solver));  // pyfwi needs to do solver2 = solver1
      },
