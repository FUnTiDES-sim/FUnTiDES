...
# for kokkos on GPU: cmake -DCMAKE_INSTALL_PREFIX=../install -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ -DUSE_KOKKOS=ON -DENABLE_CUDA=ON -DCMAKE_BUILD_TYPE=Release ..; make -j 72 
