...
if(CMAKE_CXX_COMPILER_ID MATCHES "NVHPC|PGI")
  set(CMAKE_C_FLAGS_RELEASE "-O3 -DNDEBUG -Mlarge_arrays -tp=native" CACHE STRING "")
  set(CMAKE_C_FLAGS_RELWITHDEBINFO "-g ${CMAKE_C_FLAGS_RELEASE}" CACHE STRING "" FORCE)
  set(CMAKE_C_FLAGS_DEBUG "-O0 -g -Mlarge_arrays" CACHE STRING "" FORCE)
else()
  set(CMAKE_C_FLAGS_RELEASE "-O3 -DNDEBUG -mtune=native" CACHE STRING "")
  set(CMAKE_C_FLAGS_RELWITHDEBINFO "-g ${CMAKE_C_FLAGS_RELEASE}" CACHE STRING "" FORCE)
...
if(CMAKE_CXX_COMPILER_ID MATCHES "NVHPC|PGI")
  set(CMAKE_CXX_FLAGS_RELEASE "-O3 -DNDEBUG -Mlarge_arrays -tp=native" CACHE STRING "")
  set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-g ${CMAKE_CXX_FLAGS_RELEASE}" CACHE STRING "" FORCE)
  set(CMAKE_CXX_FLAGS_DEBUG "-O0 -g -Mlarge_arrays" CACHE STRING "" FORCE)
else()
  set(CMAKE_CXX_FLAGS_RELEASE "-O3 -DNDEBUG -mtune=native" CACHE STRING "")
  set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-g ${CMAKE_CXX_FLAGS_RELEASE}" CACHE STRING "" FORCE)
