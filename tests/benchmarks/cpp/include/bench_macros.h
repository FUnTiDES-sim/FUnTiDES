...
/**
 * @brief Macro to instantiate benchmark templates for multiple template order values.
 * 
 * This macro generates four benchmark instantiations for orders 1 through 3, where each
 * instantiation uses the specified fixture, name, and type template with a configurable
 ...
 * @param TYPE The template type that accepts an integer template parameter (order)
 * @param CONFIG Additional configuration or method calls to append to each instantiation
 * 
