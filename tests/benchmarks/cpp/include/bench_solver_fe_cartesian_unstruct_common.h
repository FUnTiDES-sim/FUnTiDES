#ifndef TESTS_BENCHMARKS_CPP_INCLUDE_BENCH_SOLVER_FE_CARTESIAN_UNSTRUCT_COMMON_H_
#define TESTS_BENCHMARKS_CPP_INCLUDE_BENCH_SOLVER_FE_CARTESIAN_UNSTRUCT_COMMON_H_
...
class SolverUnstructFixture : public benchmark::Fixture {
 ...
 protected:
  ...
  std::shared_ptr<model::ModelApi<float, int>> createModel() {
    typename T::BuilderParams params(order, ex, ey, ez, lx, ly, lz, isModelOnNodes_, is_elastic);
...
#endif  // TESTS_BENCHMARKS_CPP_INCLUDE_BENCH_SOLVER_FE_CARTESIAN_UNSTRUCT_COMMON_H_
